...
- Target matrix: `netstandard2.0;net6.0;net7.0;net8.0;net9.0;net10.0`
...
- [V2 roadmap](../../../docs/maintainers/index.md) — phases, dependencies and release criteria
- [V2 program control](../../../docs/maintainers/v2-program-control.md) — private Kanban workflow and agent handoffs
