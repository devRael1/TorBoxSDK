...
public interface ISearchApiClient
{
    ...
    /// <param name="query">The search query string.</param>
    /// <param name="apiKey">Optional API key override for the Torznab endpoint, or <see langword="null"/> to use the default key.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    ...
    /// <param name="query">The search query string.</param>
    /// <param name="apiKey">Optional API key override for the Newznab endpoint, or <see langword="null"/> to use the default key.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The search results as an XML string.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="query"/> is <see langword="null"/>.</exception>
    /// <exception cref="ArgumentException">Thrown when <paramref name="query"/> is empty.</exception>
