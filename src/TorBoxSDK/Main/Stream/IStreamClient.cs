...
public interface IStreamClient
{
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="options"/> is <see langword="null"/>, or when the type in <paramref name="options"/> is <see langword="null"/>.</exception>
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="options"/> is <see langword="null"/>, or when the presigned token or token in <paramref name="options"/> is <see langword="null"/>.</exception>
