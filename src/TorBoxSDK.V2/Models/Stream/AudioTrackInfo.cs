...
public sealed record AudioTrackInfo
{
	...
	/// <summary>
	/// Gets whether this audio track is the default track, or <see langword="null"/> if not specified.
	/// </summary>
	...
	/// <summary>
	/// Gets the number of audio channels, or <see langword="null"/> if not available.
	/// </summary>
	[JsonPropertyName("channels")]
	public int? Channels { get; init; }

	/// <summary>
	/// Gets the audio channel layout, or <see langword="null"/> if not available.
	/// </summary>
	[JsonPropertyName("channel_layout")]
	public string? ChannelLayout { get; init; }

	/// <summary>
	/// Gets the audio track title, or <see langword="null"/> if not available.
	/// </summary>
