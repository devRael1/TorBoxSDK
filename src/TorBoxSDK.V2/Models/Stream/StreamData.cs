...
public sealed record StreamData
{
	...
	/// <summary>
	/// Gets whether transcoding is currently active, or <see langword="null"/> if not specified.
	/// </summary>
	[JsonPropertyName("is_transcoding")]
	public bool? IsTranscoding { get; init; }

	/// <summary>
	/// Gets whether transcoding is required, or <see langword="null"/> if not specified.
	/// </summary>
	...
	/// <summary>
	/// Gets the raw search metadata payload, or <see langword="null"/> if not available.
	/// </summary>
	[JsonPropertyName("search_metadata")]
	public JsonElement? SearchMetadata { get; init; }
}
